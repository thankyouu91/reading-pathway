...
const blogPosts = [
  {
    ...
    meta_description: 'Đề án 2371/QĐ-TTg hướng tới đưa tiếng Anh thành ngôn ngữ thứ hai tại Việt Nam. Tìm hiểu cơ hội, thách thức và giải pháp cho hệ thống giáo dục.',
    meta_keywords: 'đề án 2371, tiếng Anh ngôn ngữ thứ hai, giáo dục tiếng Anh Việt Nam, chính sách giáo dục, CEFR, Trophy9, Achieve3000'
  },
  {
    ...
    meta_description: 'Chỉ số Lexile là thước đo trình độ đọc hiểu tiếng Anh quốc tế. Tìm hiểu cách hoạt động, thang đo và cách Reading Pathway dùng Lexile để cá nhân hóa việc học.',
    meta_keywords: 'chỉ số Lexile, Lexile là gì, đo trình độ đọc hiểu, Lexile Framework, Trophy9 Lexile, Achieve3000, Reading Pathway'
  },
  {
    ...
    meta_description: 'Trophy9 tích hợp 9 hoạt động học tiếng Anh toàn diện theo chuẩn CCSS cho học sinh K-9: phonics, vocabulary, shadowing, critical thinking và nhiều hơn nữa.',
    meta_keywords: 'Trophy9, học tiếng Anh K-9, phonics tiếng Anh, CCSS, Leveled Readers, shadowing, tư duy phản biện, Reading Pathway'
  },
  {
    ...
    meta_description: 'Chiến lược đọc hiểu IELTS hiệu quả: skimming, scanning, quản lý thời gian và mở rộng từ vựng học thuật để tăng band điểm nhanh chóng.',
    meta_keywords: 'chiến lược IELTS reading, đọc hiểu IELTS, tăng band điểm IELTS, skimming scanning, từ vựng học thuật, luyện thi IELTS'
  },
  {
    ...
    meta_description: 'Achieve3000 là nền tảng đọc hiểu thích ứng cho học sinh THPT và đại học, sử dụng chỉ số Lexile để cá nhân hóa nội dung và nâng cao năng lực tiếng Anh toàn diện.',
    meta_keywords: 'Achieve3000, đọc hiểu tiếng Anh THPT, chỉ số Lexile, học tiếng Anh thích ứng, Reading Pathway, IELTS preparation, adaptive learning'
  },
  {
    ...
    meta_description: 'Blended learning kết hợp lớp học truyền thống và công nghệ số để tối ưu việc dạy tiếng Anh. Hướng dẫn triển khai hiệu quả tại trường học Việt Nam.',
    meta_keywords: 'blended learning tiếng Anh, phương pháp dạy tiếng Anh hiện đại, flipped classroom, station rotation, giáo dục số Việt Nam, dạy học kết hợp'
  }
];
